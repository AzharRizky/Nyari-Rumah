...
<html lang="en">
    <head>
        ...
        <title>Nyari Rumah | Contact Us</title>
    </head>
    <body>
        <!-- Nav Bar -->
            ...
            <div class="container">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-4 text-center">
                        <h1 data-aos-delay="400" data-aos-duration="800" data-aos="fade-down">Hubungi Kami</h1>
                    </div>
                    <div class="col-md-4"> </div>
                </div>
                <!-- Content -->
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div data-aos-delay="400" data-aos-duration="800" data-aos="fade-up" class="card p-4">
                            <div class="row">
                                <div class="col-md-1"></div>
                                <div class="col-md-10 p-3 text-center">
                                    <i class="fa fa-briefcase mb-3"></i>
                                    <h3>For Business Inquiry:</h3>
                                    <a href="mailto:%3CHuala%3Ehualamanurung568@gmail.com?%20subject=Hello%20Pak%20Huala">
                                        <p>hualamanurung568@gmail.com</p>
                                    </a>
                                </div>
                                <div class="col-md-1"></div>
                            </div>
                            <div class="row pb-3" id="contact">
                                <div class="text-center">
                                    <a href="tel:+6281213278333"><i class="fa fa-phone"></i></a>
                                    <a href="tel:+6281314870333"><i class="fa fa-mobile-phone"></i></a>
                                    <a href="mailto:%3CIvana%3Ejustmevan19@gmail.com?%20subject=Hello%20Ivana"><i class="fa fa-envelope"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
